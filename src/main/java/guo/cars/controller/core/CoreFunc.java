...
public class CoreFunc {
     ...
     */
    public Mat colorMatch(final Mat src, final Color r, final boolean adaptive_minsv) {
     ...
     * @return
     */
    public boolean plateColorJudge(final Mat src, final Color color, final boolean adaptive_minsv) {
        // 判断阈值
     ...
     * @return
     */
    public Color getPlateType(final Mat src, final boolean adaptive_minsv) {
     ...
     * @return
     */
    public float[] projectedHistogram(final Mat img, Direction direction) {
        int sz = 0;
        switch (direction) {
        case HORIZONTAL:
            sz = img.rows();
     ...
     * @return
     */
    public Mat features(final Mat in, final int sizeData) {
     ...
     * @param src
     */
    public void showImage(final String title, final Mat src) {
        if(src!=null){
