...
public class CharsSegment {
    ...
    public int charsSegment(final Mat input, Vector<Mat> resultVec) {
        ...
        functionControler.recordProcess("进行字符识别的二值化图像","tmp/debug_char_threshold.jpg");

        // 去除车牌上方的柳钉以及下方的横线等干扰
        //clearLiuDing(img_threshold);
       
//        if (this.isDebug) {
//            String str1 = "tmp/debug_char_clearLiuDing.jpg";
//            opencv_imgcodecs.imwrite(str1, img_threshold);
//        }
        ...
        int specIndex = GetSpecificRect(sortedRect);
            ...
            if (specIndex < sortedRect.size()) {
                ...
                functionControler.recordProcess("获取特定的城市代码，如粤A的\"a\"",str);
            }
        ...
        functionControler.recordProcess("获取城市中文字符",str);
        ...
        for (int i = 0; i < newSortedRect.size(); i++) {
            ...
            auxRoi = preprocessChar(auxRoi);
                ...
                str = "tmp/debug_char_auxRoi_" + Integer.valueOf(i).toString() + ".jpg";
                opencv_imgcodecs.imwrite(str, auxRoi);
            functionControler.recordProcess("排列出第"+ i +"个车牌字符",str);
...
//            
    ...
    private boolean isDebug = true;//DEFAULT_DEBUG;
}
